...
import { createRefreshToken, createUser, deleteUsers, getUserByEmail, updateUser, } from "./db/queries/users.js";
import { createChirp, getAllChirps, getChirpsById, deleteChirps } from "./db/queries/chirps.js";
import { eq } from "drizzle-orm";
import { hashPassword, checkPassword, makeJWT, getBearerToken, validateJWT, makeRefreshToken, } from "./db/auth.js";
...
app.post("/api/refresh", async (req, res, next) => {
    try {
        ...
        const newToken = makeJWT(dbToken.userId, ACCESS_TOKEN_EXPIRATION, config.jwtSecret);
